...
import { TransferMoneyController } from '../modules/statements/useCases/transferMoney/TransferMoneyController';
...
const transferMoneyController = new TransferMoneyController();
...
statementRouter.post('/transfers/:user_id', transferMoneyController.execute);
